...
const InvestorDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      {/* Mobile-specific CSS fix - only applies on small screens */}
      <style jsx>{`
      ...
      {/* Main content with mobile fix */}
      <div className="mobile-dashboard-fix">
        <div className="container mx-auto px-4 py-6 mobile-content-fix">
