    ...
    <section className="relative py-20 px-6 bg-gradient-to-b from-white via-yellow-50 to-white">
      ...
      <div className="flex flex-col gap-10 md:hidden">
        {stages.map((stage, i) => (
          ...
          >
            {/* Marker */}
            <div className="w-8 h-8 rounded-full bg-yellow-600 border-4 border-white shadow-md 
              transition duration-300 group-hover:scale-125 group-hover:shadow-yellow-400 group-hover:shadow-lg" />
            
            {/* Stage Card */}
            <div className="bg-white rounded-xl shadow-md px-4 py-2 transition duration-300 
              group-hover:scale-105 group-hover:shadow-xl group-hover:bg-yellow-50">
        ...
        <div className="grid grid-cols-7 gap-4 relative">
          {stages.map((stage, i) => (
            ...
            >
              ...
              {/* Stage Card */}
              <div className="mt-6 bg-white rounded-xl shadow-md px-4 py-2 text-center w-28 
